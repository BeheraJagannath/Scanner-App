...
class ScannerActivity : AppCompatActivity() {
    ...
    private var scannerSDK: MainActivity.ScannerSDK = MainActivity.ScannerSDK.MLKIT
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        scannerSDK = intent?.getSerializableExtra("scanning_SDK") as MainActivity.ScannerSDK


        when (scannerSDK) {
            MainActivity.ScannerSDK.MLKIT -> binding.ivScannerLogo.setImageResource(R.drawable.mlkit_icon)
            MainActivity.ScannerSDK.ZXING -> binding.ivScannerLogo.setImageResource(R.drawable.zxing)
        }
    ...
    private fun bindPreview(cameraProvider: ProcessCameraProvider?) {
        ...
        if (scannerSDK == MainActivity.ScannerSDK.ZXING) {
